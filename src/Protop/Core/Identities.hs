...
instance IsObject x => Singleton (Id x) where
...
instance IsMorphism a => Singleton (IDLEFT a) where
    singleton = IDLEFT singleton
...
instance IsMorphism a => Singleton (IDRIGHT a) where
    singleton = IDRIGHT singleton
