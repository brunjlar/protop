...
instance CProd a b => Singleton (a :* b) where
...
instance CProd a b => Singleton (Pr1 a b) where
    singleton = Pr1 singleton singleton
...
instance CProd a b => Singleton (Pr2 a b) where
    singleton = Pr2 singleton singleton
...
instance CProd' a b => Singleton (PROD1 a b) where
    singleton = PROD1 singleton singleton
...
instance CProd' a b => Singleton (PROD2 a b) where
    singleton = PROD2 singleton singleton
...
instance CPROD a b c => Singleton (PROD a b c) where
    singleton = PROD singleton singleton singleton
